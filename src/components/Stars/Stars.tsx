...
export default function Stars({ }: Props) {
    return (
        <svg width="830px" height="1603px" viewBox="-1 -1 830 1603" version="1.1" xmlns="http://www.w3.org/2000/svg" >
            <desc>Created with Sketch.</desc>
            <defs />
            <g id="Group" opacity="0.25" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g transform="translate(414.000000, 801.000000) rotate(-270.000000) translate(-414.000000, -801.000000) translate(-387.000000, 387.000000)" id="Oval" fill-rule="nonzero" fill="#FFFFFF">
